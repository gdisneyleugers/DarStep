...
# SYSTEM domain
#
GNUSTEP_SYSTEM_APPS        ?= /usr/local/lib/GNUstep/Applications
GNUSTEP_SYSTEM_ADMIN_APPS  ?= /usr/local/lib/GNUstep/Applications
GNUSTEP_SYSTEM_WEB_APPS    ?= /usr/local/lib/GNUstep/WebApplications
GNUSTEP_SYSTEM_TOOLS       ?= /usr/local/bin
GNUSTEP_SYSTEM_ADMIN_TOOLS ?= /usr/local/sbin
GNUSTEP_SYSTEM_LIBRARY     ?= /usr/local/lib/GNUstep
GNUSTEP_SYSTEM_HEADERS     ?= /usr/local/include
GNUSTEP_SYSTEM_LIBRARIES   ?= /usr/local/lib
GNUSTEP_SYSTEM_DOC         ?= /usr/local/share/GNUstep/Documentation
GNUSTEP_SYSTEM_DOC_MAN     ?= /usr/local/share/man
GNUSTEP_SYSTEM_DOC_INFO    ?= /usr/local/share/info
...
GNUSTEP_NETWORK_WEB_APPS    ?= /usr/local/lib/GNUstep/WebApplications
